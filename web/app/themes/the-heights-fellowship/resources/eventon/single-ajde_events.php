  ...
  <body <?php body_class(); ?>>
    ...
    <header class="banner">
      <a class="brand" href="/">
        ...
        <svg version="1.1" id="Layer_1" class="logo-words" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        ...
        <nav class="nav-secondary">
          <p class="nav-secondary__title"><a href="<?php bloginfo('url') ?>"><?php bloginfo('name'); ?></a></p>
          <?php wp_nav_menu(['theme_location' => 'secondary_navigation', 'menu_class' => 'nav']); ?>
        </nav>
        <?php } ?>
    ...
    <footer class="content-info">
      <a href="/" class="footer__logo">
        <img src="<?php echo get_template_directory_uri() . '/assets/images/thflogosquarewhite.svg'; ?>" alt="The Heights Fellowship logo white">
      </a>
      ...
      <p class="copyright">&copy; The Heights Fellowship <?php echo date('Y') ?></p>
    </footer>
    <?php wp_footer(); ?>
  </body>
</html>
